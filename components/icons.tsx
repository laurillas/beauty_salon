...
export function TikTokIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M16.6 5.82a4.28 4.28 0 0 1-1.06-2.82h-3.2v13.3a2.6 2.6 0 1 1-2.6-2.6c.27 0 .53.04.78.12V8.53a5.9 5.9 0 0 0-.78-.05A5.83 5.83 0 1 0 15.4 14.3V8.87a7.4 7.4 0 0 0 4.32 1.38V7.05a4.28 4.28 0 0 1-3.12-1.23z" />
    </svg>
  )
}
